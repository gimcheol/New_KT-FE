...
const validatePwd = (password) => {
    ...
    const numOfConditions = [hasNumber, hasSpecial, hasAlphabet].filter(Boolean).length;
...
const SignupForm = () => {
    ...
    const handleSubmit = (event) => {
        ...
        if (!validatePwd(password)) {
          setErrorMsg("영문, 숫자, 특수문자(() < > \" ' ; 제외)중 2종류를 조합하여 10~16자리 (3종류는 8~16자리)로 구성할 수 있습니다.");
          return;
        }
                        ...
                        <Form>
                            ...
                            <Row>
                                <FormGroup className="col-md-6">
                                    ...
                                    <Input type="email" className="form-control" id="email" placeholder="Ex) a000000@aivle.kt.co.kr" />
                                </FormGroup>
                            </Row>
                            <Row>
                                <FormGroup className="col-md-6">
                            ...
                            <Row>
                                <FormGroup className="col-md-6">
                                    ...
                                    />
                                    {confirmPassword !== password && <div style={{ color: 'red' }}>Password does not match</div>}
                                </FormGroup>
                            </Row>
                            <Row>
                                <FormGroup className="col-md-6 ml-3">
                                    <Input id="checkbox1" type="checkbox" />
                                    <Label htmlFor="checkbox1"> 약관 동의 </Label>
                                </FormGroup>
                            </Row>
                            <Row>
                                <Col md="6">
                                    <Button type="submit" onClick={handleSubmit} className="btn btn-success waves-effect waves-light m-r-10">Submit</Button>
