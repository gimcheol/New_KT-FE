...
const TermsModal = ({ isOpen, toggleModal, onConfirm }) => {
    ...
    const handleConfirm = () => {
        ...
        if (newKTAgrreement && personalInfoAgreement) {
    ...
    return (
        <Modal isOpen={isOpen} toggle={toggleModal}>
            ...
            <ModalBody>
                <FormGroup check>
                    <Label check>
                        <Input
                            ...
                            onChange={() => setNewKTAgrreement(!newKTAgrreement)}
                        />
                ...
                <p>
                    필수 항목은 서비스 제공을 위해 필요한 항목이므로,
                    동의를 거부하시는 경우 서비스 이용에 제한이 있을 수 있습니다.
                </p>
                ...
                <FormGroup check>
                    <Label check>
                        <Input
                            ...
                            onChange={() => setPersonalInfoAgreement(!personalInfoAgreement)}
                        />
                        [필수] 개인정보 수집 및 이용 동의
                    </Label>
                </FormGroup>
            ...
            <ModalFooter>
                <Button color="primary" onClick={handleConfirm} disabled={!newKTAgrreement || !personalInfoAgreement}>
                    확인
                </Button>
